...
<div class = "container-fluid">
	<div class = "container">
					...
					<thead>
  					...
  					<c:forEach var = "dir" items = "${lista}">
  						<tr>
							...
							<td><a href="cuentaCliente?action=eliminarDireccion&direccion=<c:out value="${dir.direccion}"/>" class="btn btn-danger" role="button" aria-pressed="true" >Eliminar</a> </td>
  						</tr>
  					</c:forEach>
				</table>
			</div>
		...
		<a href="cuentaCliente?action=nuevaDireccion" class="btn btn-info" role="button" aria-pressed="true">Agregar dirección</a>
	</div>
</div>	
</body>
</html>