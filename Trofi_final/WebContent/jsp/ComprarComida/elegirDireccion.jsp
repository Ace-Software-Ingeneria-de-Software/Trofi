...
<div class = "container-fluid">
	<div class = "container">
		<h1 class = "text-left" id = "title"> Direcciones </h1>
		<hr>
		<div class="row">
					...
					<thead>
  					...
  					<c:forEach var = "dir" items = "${lista}">
  						<tr>
							...
							<td><a href="menuCliente?action=crearPedido&direccion=<c:out value="${dir.direccion}"/>" class="btn btn-success" role="button" aria-pressed="true" >Seleccionar</a> </td>
  						</tr>
  					</c:forEach>
				</table>
			</div>
		...
		<a href="cuentaCliente?action=nuevaDireccion&desdePedido=<c:out value="${desdePedido}"/>&correo=<c:out value="${correo}"/>" class="btn btn-info active" role="button" aria-pressed="true">Agregar dirección</a>
	</div>
</div>
</body>
</html>