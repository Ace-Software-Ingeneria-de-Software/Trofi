...
<div class = "container-fluid">
	<div class = "container">
		<h1 class = "text-left" id = "title"> Ordenes aceptadas </h1>
		<hr>
		<div class="row">
					...
					<thead>
  					...
  					<c:forEach var = "orden" items = "${lista}">
  						<tr>
							...
							<td><a href="muestra_orden?action=cambiarEstado&id_orden=<c:out value="${orden.id_orden}" />&correoCliente=<c:out value="${orden.correo_cl}" />" class="btn btn-success" role = "button" aria-pressed="true" >Cambiar Estado</a></td>
  						</tr>
  					</c:forEach>
				</table>
			</div>
