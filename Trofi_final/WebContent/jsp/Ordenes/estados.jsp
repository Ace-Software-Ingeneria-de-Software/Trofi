...
<div class = "container-fluid">
	<div class = "container">
		<h1 class = "text-left" id = "title"> Estados disponibles </h1>
		<hr>
		<div class="row">
					...
					<thead>
  					...
  					<c:forEach var = "estados" items = "${lista}">
  						<tr>
							...
							<td><a href="muestra_orden?action=aviso&estado=<c:out value="${estados}" />&id_orden=<c:out value="${id_orden}" />&correoCliente=<c:out value="${correoCliente}" />" class="btn btn-success" role = "button" aria-pressed="true">Aceptar</a></td>
  						</tr>
  					</c:forEach>
				</table>
			</div>
